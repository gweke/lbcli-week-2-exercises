...
# and to be RBF, we will add sequence:1, in the input parameters
# the createrawtransaction will return an hex of the raw transaction

# We'll use the output of the rawtx as the inputs of the rawtx that we will made
...
raw_unsigned=$(bitcoin-cli -regtest createrawtransaction \
  "[{\"txid\": \"$txid\", \"vout\": $vout_0, \"sequence\": 1}, {\"txid\": \"$txid\", \"vout\": $vout_1, \"sequence\": 1}]" \
